...
public class SharedConfiguration {
    ...
    public Step shareStep() {
        return stepBuilderFactory.get("shareJob")
    ...
    public Step shareStep2() {
        ...
        /**
         * job의 executionContext는 같은 job이 관리하는 step 에서 공유 가능하다.
         * step의 excutionContext는 같은 step 내에서만 공유 가능하다.
         */
